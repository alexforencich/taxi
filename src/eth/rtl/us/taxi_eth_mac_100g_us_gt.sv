 ...
 */
module taxi_eth_mac_100g_us_gt #
(
...
if (SIM) begin : xcvr
    ...
    taxi_eth_mac_100g_us_gty_full
    taxi_eth_mac_100g_us_gty_full_inst (
        // Common
    ...
    taxi_eth_mac_100g_us_gty_ch
    taxi_eth_mac_100g_us_gty_ch_inst (
        // Common
        .gtpowergood_out(xcvr_gtpowergood_out),
