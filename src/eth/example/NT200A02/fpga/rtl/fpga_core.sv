...
if (MAC_CNT == 2) begin
    ...
    assign qsfp_led[0][1] = 1'b0;
    assign qsfp_led[0][2] = 1'b0;
    assign qsfp_led[0][3] = 1'b0;
    assign qsfp_led[1][0] = eth_gty_rx_status[1];
    assign qsfp_led[1][1] = 1'b0;
    assign qsfp_led[1][2] = 1'b0;
    assign qsfp_led[1][3] = 1'b0;
end else begin
    assign qsfp_led[0][0] = eth_gty_rx_status[0];
...
for (genvar n = 0; n < GTY_QUAD_CNT; n = n + 1) begin : gt_quad
    ...
    if (MAC_DATA_W == 512) begin: mac
        ...
        taxi_eth_mac_100g_us #(
            ...
            .STAT_STR_EN(0),
            .STAT_PREFIX_STR(n == 0 ? "QSFP0" : "QSFP1")
        )
        mac_inst (
             ...
             * MAC clocks
             */
            .rx_clk(eth_gty_rx_clk[n]),
            .rx_rst_in(1'b0),
            .rx_rst_out(eth_gty_rx_rst[n]),
            .tx_clk(eth_gty_tx_clk[n]),
            .tx_rst_in(1'b0),
            .tx_rst_out(eth_gty_tx_rst[n]),

            /*
             * Transmit interface (AXI stream)
             */
            .s_axis_tx(eth_gty_axis_tx[n]),
            .m_axis_tx_cpl(eth_gty_axis_tx_cpl[n]),
...
for (genvar n = 0; n < $size(eth_gty_axis_tx); n = n + 1) begin : gty_ch
