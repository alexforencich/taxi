 ...
 */
module taxi_eth_mac_100g_us_gt_ll #
(
...
if (SIM) begin : xcvr
    ...
    taxi_eth_mac_100g_us_gty_ll_full
    taxi_eth_mac_100g_us_gty_ll_full_inst (
        // Common
        ...
        .qpll0pd_in(gt_qpll0_pd),
        .qpll0reset_in(gt_qpll0_reset),
        .qpll1pd_in(gt_qpll1_pd),
        .qpll1reset_in(gt_qpll1_reset),
        ...
        .txdata_in(serdes_txdata),
        .txctrl0_in(serdes_txctrl0),
        .txctrl1_in(serdes_txctrl1),
        ...
        .rxdata_out(serdes_rxdata),
        .rxctrl0_out(serdes_rxctrl0),
        .rxctrl1_out(serdes_rxctrl1)
    );
    ...
    taxi_eth_mac_100g_us_gty_ll_ch
    taxi_eth_mac_100g_us_gty_ll_ch_inst (
        // Common
        .gtpowergood_out(xcvr_gtpowergood_out),
